namespace BTC_ENTERPRISE.YaoUI
{
    internal class UIManager
    {
        ...
        {
            Panel_menubar = panelMenubar;
            panel_main_display = panelMainContent;
        }
        ...
        public void ActivateButton(object btnSender)
        {
            if (btnSender != null && btnSender is Button)
            {
                ...
                if (currentButton == null || currentButton.Name != senderButton.Name)
                {
                    ...
                    currentButton.Font = new Font("Arial Narrow Bold", 8.0F, FontStyle.Bold, GraphicsUnit.Point, 0);
        ...
        private void DisableButton()
        {
            foreach (Control previousBtn in Panel_menubar.Controls)
            {
                if (previousBtn is Button)
                {
                    ...
                    previousBtn.Font = new Font("Arial Narrow Bold", 8.0F, FontStyle.Bold, GraphicsUnit.Point, 0);
                }
            }
        }
        #endregion
